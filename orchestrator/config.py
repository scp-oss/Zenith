...
# (пункт 14 -> 2 -> 4 -> 5 "Профили", был 21, потом 30, см.
# z2r_autobench/CLAUDE.md для полной истории перенумерации), не руками --
# меню само проверяет
...
# раньше). Ставится через z0r (пункт 11 -> 2 "Профили для продвижения",
# был 18, потом 27, см. z2r_autobench/CLAUDE.md для полной истории
# перенумерации).
