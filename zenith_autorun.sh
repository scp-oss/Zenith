...
# не через окружение -- см. z0r 14 -> 2 -> 4 -> "профили" (был 21, потом
# 30, см. z2r_autobench/CLAUDE.md для полной истории перенумерации).
#
...
# Живой случай 2026-08-24 на Server B (Provider B, hub-and-spoke): main.py честно
...
while true; do
  ...
  # Живой случай на Server B 2026-08-26: main.py падал с необработанным
